...
import com.shanyangcode.infinitechat.messageingservice.data.sendRedPackage.RedPacketMessageBody;
import com.shanyangcode.infinitechat.messageingservice.data.sendRedPackage.SendRedPacketRequest;
import com.shanyangcode.infinitechat.messageingservice.data.sendRedPackage.SendRedPacketResponse;
...
public class RedPacketServiceImpl extends ServiceImpl<RedPacketMapper, RedPacket> implements RedPacketService {
    ...
    private RedPacket createRedPacket(Long senderId, SendRedPacketRequest request,
        ...
        if (!this.save(redPacket)) {
            throw new ServiceException("创建红包记录失败");
        }
